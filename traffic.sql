...
DROP TABLE IF EXISTS `motorcycle_riders`;
CREATE TABLE `motorcycle_riders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `has_helmet` tinyint(4) NOT NULL,
  ...
  CONSTRAINT `motorcycle_riders_ibfk_1` FOREIGN KEY (`vehicles_id`) REFERENCES `vehicles` (`id`),
  CONSTRAINT `motorcycle_riders_ibfk_2` FOREIGN KEY (`vehicles_locations_id`) REFERENCES `vehicles` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
